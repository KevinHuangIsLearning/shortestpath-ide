...
// Opens the Competitive Champion integration guide in the system browser from
// the top of the CPH settings page.
...
async function openCompetitiveChampionDoc(): Promise<void> {
	try {
		await vscode.env.openExternal(vscode.Uri.parse(competitiveChampionDocUrl));
	} catch (error) {
