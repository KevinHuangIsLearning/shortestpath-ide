...
export const getVjudgeOpenInBrowser = (): boolean =>
    getPreference('general.vjudgeOpenInBrowser') || false;

export const getVjudgeUrlSuffix = (): string =>
    getPreference('general.vjudgeUrlSuffix') || '';

export const getVjudgeBrowserSplitRatio = (): number => {
    const r = getPreference('general.vjudgeBrowserSplitRatio');
