...
export class CodeApplication extends Disposable {
	...
	private getShortestPathPlatformInstaller(): IShortestPathPlatformInstaller {
		const installerPath = join(this.environmentMainService.appRoot, 'extensions', 'shortestpath.setup', 'resources', `${this.getShortestPathPlatformName()}.js`);
