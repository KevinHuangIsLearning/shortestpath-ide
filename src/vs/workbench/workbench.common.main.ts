...
import { ILanguageModelIgnoredFilesService, LanguageModelIgnoredFilesService } from './contrib/chat/common/ignoredFiles.js';
...
// Keep the extension-host language model protocol alive without registering Chat UI.
