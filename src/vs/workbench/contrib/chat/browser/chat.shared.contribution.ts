...
import { AgentHostAhpJsonlLoggingSettingId, AgentHostSdkSandboxEnabledSettingId, CodexPreferAgentHostEditorSettingId } from '../../../../platform/agentHost/common/agentService.js';
...
// Shared chat types remain available to core services, but ShortestPath does
// not expose the Chat/agent configuration surface in the OI distribution.
